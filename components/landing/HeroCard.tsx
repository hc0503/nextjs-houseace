...
function HeroCard() {
    return (
        <div className="relative">
            ...
            <div className="relative container mx-auto pt-16 pb-16 sm:pt-24 sm:pt-16 lg:pt-64 lg:pb-28 text-white px-5 sm:px-0">
                <p className="font-bold mb-4 lg:text-4xl md:text-2xl sm:text-xl text-lg">Using the Calculator</p>
